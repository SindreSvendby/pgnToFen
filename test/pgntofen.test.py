...
class PgnToFenTester(unittest.TestCase):
    ...
    #    correctFen = 'Qnbqkbnr/1ppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR'
    ...
    #
    #
    # def test_real_example_rook_move(self):
    #     pgnConverter = pgntofen.PgnToFen()
    #     pgnConverter.resetBoard()
    #     pgnConverter.internalChessBoard = [
    #     ['R', '1', '1', 'Q', 'R', '1', 'K', '1'],
    ...
    #     ['r', '1', '1', '1', '1', 'r', 'k', '1']]
    #     pgnConverter.whiteToMove = False
    #     pgnConverter.pgnToFen(['Rae8']);
    #     correctFen = '4rrk1/1b3pp1/1n3q1p/2p1N3/1pB5/7P/PP3PP1/R2QR1K1 w - KQq'
    #     self.assertEqual(correctFen, pgnConverter.getFullFen())
    #
    #
    # def test_real_example_rook_move2(self):
    #     pgnConverter = pgntofen.PgnToFen()
    #     pgnConverter.resetBoard()
    #     pgnConverter.internalChessBoard = [
    #     ['R', '1', '1', 'Q', 'R', '1', 'K', '1'],
    ...
    #     ['1', '1', '1', '1', 'r', 'r', 'k', '1']]
    #     pgnConverter.whiteToMove = False
    #     pgnConverter.pgnToFen(['Rxf7']);
    #     correctFen = '4r1k1/1b3rp1/1n3q1p/2p1N3/1p6/7P/PP3PP1/R2QR1K1 w - KQkq'
    #     self.assertEqual(correctFen, pgnConverter.getFullFen())
    #
    #
    # def test_real_example_rook_move3(self):
    #     pgnConverter = pgntofen.PgnToFen()
    #     pgnConverter.resetBoard()
    #     pgnConverter.internalChessBoard = [
    #     ['R', '1', '1', '1', '1', '1', 'K', '1'],
    ...
    #     ['R', 'b', '1', '1', 'r', 'p', '1', 'p'],
    #     ['1', 'q', 'r', '1', '1', '1', 'k', '1']]
    #     pgnConverter.pgnToFen(['R7a2']);
    #     correctFen = '1qr3k1/1b2rp1p/1p3np1/3pn3/1P1N4/1QN1P2P/R3BPP1/R5K1 b - KQkq'
    #     self.assertEqual(correctFen, pgnConverter.getFullFen())
    #
